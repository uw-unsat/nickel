class BaseIRPyEvaluator(object):
    ...
    def insertvalue(self, ctx, *args, **kwargs):
        raise NotImplementedError("insertvalue {} {}".format(args, kwargs))

    def extractvalue(self, ctx, *args, **kwargs):
        raise NotImplementedError("extractvalue {} {}".format(args, kwargs))
