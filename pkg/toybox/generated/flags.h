...
// blockdev   <1>1(setro)(setrw)(getro)(getss)(getbsz)(setbsz)#<0(getsz)(getsize)(getsize64)(flushbufs)(rereadpt)
...
// cp   <2(preserve):;RHLPprdaslvnF(remove-destination)fi[-HLPd][-ni]
#undef OPTSTR_cp
...
// grep   S(exclude)*M(include)*C#B#A#ZzEFHabhinorsvwclqe*f*m#x[!wx][!EFw]
#undef OPTSTR_grep
...
// iotop   >0AaKOHk*o*p*u*s#<1=7d#=3<1m#n#<1bq
#undef OPTSTR_iotop
...
// patch   (dry-run)xd:ulp#i:R
#undef OPTSTR_patch
#define OPTSTR_patch "(dry-run)xd:ulp#i:R"
#ifdef CLEANUP_patch
#undef CLEANUP_patch
#undef FOR_patch
#undef FLAG_R
...
// top   >0O*Hk*o*p*u*s#<1d#=3<1m#n#<1bq[!oO]
#undef OPTSTR_top
...
#define FLAG_getsize64 (FORCED_FLAG<<2)
#define FLAG_getsize (FORCED_FLAG<<3)
#define FLAG_getsz (FORCED_FLAG<<4)
#define FLAG_setbsz (FORCED_FLAG<<5)
#define FLAG_getbsz (FORCED_FLAG<<6)
#define FLAG_getss (FORCED_FLAG<<7)
#define FLAG_getro (FORCED_FLAG<<8)
#define FLAG_setrw (FORCED_FLAG<<9)
#define FLAG_setro (FORCED_FLAG<<10)
#endif
...
#define FLAG_preserve (FORCED_FLAG<<15)
#endif
...
#define FLAG_i (FORCED_FLAG<<13)
#define FLAG_h (FORCED_FLAG<<14)
#define FLAG_b (FORCED_FLAG<<15)
#define FLAG_a (FORCED_FLAG<<16)
#define FLAG_H (FORCED_FLAG<<17)
#define FLAG_F (FORCED_FLAG<<18)
#define FLAG_E (FORCED_FLAG<<19)
#define FLAG_z (FORCED_FLAG<<20)
#define FLAG_Z (FORCED_FLAG<<21)
#define FLAG_A (FORCED_FLAG<<22)
#define FLAG_B (FORCED_FLAG<<23)
#define FLAG_C (FORCED_FLAG<<24)
#define FLAG_include (FORCED_FLAG<<25)
#define FLAG_M (FORCED_FLAG<<25)
#define FLAG_exclude (FORCED_FLAG<<26)
#define FLAG_S (FORCED_FLAG<<26)
#endif
